...
public final class FindAction {
    ...
    {
        String convertedXml = TransformationUtil.getXml("C:\\Users\\LUTFI\\Downloads\\induction-task-master\\literatum-lutfi\\web\\actions\\actions.xml","C:\\Users\\LUTFI\\Downloads\\induction-task-master\\literatum-lutfi\\web\\actions\\actions.xsl");
        String actionUrl;
        String actionClass;
    ...
    public static IAction findAction(String requestURL) throws NoSuchMethodException, ClassNotFoundException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        Class<?> action = Class.forName(urlToClassMap.get(requestURL.toString().substring(requestURL.toString().length()-5)));
